...
For memory changes, read the engine, runtime and preparation contracts together as applicable. Keep research findings source-linked and distinguish observed code behavior from selected requirements. Never summarize away a missing obligation to make a packet look complete.
