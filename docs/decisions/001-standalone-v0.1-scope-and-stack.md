...
- **Status:** accepted and complete. The project licence, the model provider, the spend ceiling and the journey-6 pilot repository were all decided on 2026-09-16. Question 11, how source identity reaches git, was recorded on 2026-09-17 after M2's review. Nothing in this record is unresolved.
- **Date:** 2026-09-16.
