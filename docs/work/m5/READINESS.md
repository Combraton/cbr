...
9. **J4's "deduplication disabled" control is worded** "with the commit's durable identity removed, two findings; with deduplication removed, a typed conflict and no section". Answered in the session.
