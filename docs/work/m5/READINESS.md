...
- **The expected spend is about 45,000**: the core runs spent 23,931 and 22,684 at `/1` with three parts each, and each part's question is now a preamble longer. Red and green, which spent 73,452 between them at `/1`, now spend nothing.
