...
- **Inspected source revision:** `main` at `bff78df365d1736bec48d0c2ff6e58b511faf40c`, clean before this documentation change. This snapshot is introduced by the subsequent maintenance commit; use Git history for that commit's identity.
...
- **Next action:** Follow the Protocol release readiness decision, then begin the agreed standalone CBR release with a task and pinned Protocol version. Preserve direct-provider operation without PIO and bounded evidence-backed memory work.
