...
At `a98235c`, the last commit with tests, with this docs commit's edits in place; this docs commit changes Markdown and T3's comment only. Provider code changed in `5891542`, the fourth fix round's fix, and nowhere else since `104615d` but `448b3c2`'s doc comment.
