...
**Next.** m5b, the loop and its checkpoints, once the owner rules on its three open decisions (the entry point, J4's control wording, and CBR's own commands' authorisation).
