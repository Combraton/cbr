...
- [ADR 001](decisions/001-standalone-v0.1-scope-and-stack.md) — the accepted scope, stack and evaluation posture for standalone v0.1. Every owner decision on scope and stack is recorded there; those made within M5 are listed at the top of [m5 READINESS](work/m5/READINESS.md).
